...
// clang-format off
// IPJ_autogen | gen_c_regions_ex10_regulatory | region_name:China {
static channel_index_t const china_usable_channels[] = {3, 7, 11, 15};
    ...
    .regulatory_channels =
        {
            ...
            .usable_count   =
                (channel_size_t)ARRAY_SIZE(china_usable_channels),
            .random_hop     = false,
        },
    .pll_divider    = 48,
