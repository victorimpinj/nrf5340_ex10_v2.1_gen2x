...
// clang-format off
// IPJ_autogen | gen_c_regions_ex10_regulatory | region_name:INDIA {
static channel_index_t const india_usable_channels[] = {1, 4, 7, 10};
    ...
    .regulatory_channels =
        {
            ...
            .usable_count   =
                (channel_size_t)ARRAY_SIZE(india_usable_channels),
            .random_hop     = false,
        },
    .pll_divider    = 60,
