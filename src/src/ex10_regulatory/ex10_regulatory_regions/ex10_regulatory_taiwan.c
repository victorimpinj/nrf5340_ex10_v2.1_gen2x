...
// clang-format off
// IPJ_autogen | gen_c_regions_ex10_regulatory | region_name:TAIWAN {
static channel_index_t const taiwan_usable_channels[] = {
    ...
    .regulatory_channels =
        {
            ...
            .usable_count   =
                (channel_size_t)ARRAY_SIZE(taiwan_usable_channels),
            .random_hop     = true,
        },
    .pll_divider    = 24,
