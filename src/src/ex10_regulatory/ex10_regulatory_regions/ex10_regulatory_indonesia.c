...
// clang-format off
// IPJ_autogen | gen_c_regions_ex10_regulatory | region_name:INDONESIA {
static channel_index_t const indonesia_usable_channels[] = {37, 38, 39, 40};
    ...
    .regulatory_channels =
        {
            ...
            .usable_count   =
                (channel_size_t)ARRAY_SIZE(indonesia_usable_channels),
            .random_hop     = true,
        },
    .pll_divider    = 24,
