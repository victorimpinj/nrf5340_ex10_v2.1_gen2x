...
// clang-format off
// IPJ_autogen | gen_c_regions_ex10_regulatory | region_name:JAPAN_916_921_MHZ {
static channel_index_t const japan_916_921_mhz_usable_channels[] = {5, 11, 17, 23};
    ...
    .regulatory_timers =
        {
            ...
            .extended_ms         = 3980,
            .regulatory_ms       = 4000,
            .off_same_channel_ms = 50,
        },
    .regulatory_channels =
        {
            .start_freq_khz = 916000,
            .spacing_khz    = 200,
            .count          = 4,
            .usable         = japan_916_921_mhz_usable_channels,
            .usable_count   =
                (channel_size_t)ARRAY_SIZE(japan_916_921_mhz_usable_channels),
            .random_hop     = false,
        },
    .pll_divider    = 60,
