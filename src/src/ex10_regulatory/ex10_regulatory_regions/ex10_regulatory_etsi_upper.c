...
// clang-format off
// IPJ_autogen | gen_c_regions_ex10_regulatory | region_name:ETSI_UPPER {
static channel_index_t const etsi_upper_usable_channels[] = {3, 6, 9};
...
static const struct Ex10Region region = {
    ...
    .regulatory_channels =
        {
            .start_freq_khz = 915500,
            .spacing_khz    = 400,
            .count          = 3,
            .usable         = etsi_upper_usable_channels,
            .usable_count   =
                (channel_size_t)ARRAY_SIZE(etsi_upper_usable_channels),
            .random_hop     = false,
        },
    .pll_divider    = 60,
