...
// clang-format off
// IPJ_autogen | gen_c_regions_ex10_regulatory | region_name:PERU {
static channel_index_t const peru_usable_channels[] = {
    ...
    .regulatory_channels =
        {
            ...
            .usable_count   =
                (channel_size_t)ARRAY_SIZE(peru_usable_channels),
            .random_hop     = true,
        },
    .pll_divider    = 24,
