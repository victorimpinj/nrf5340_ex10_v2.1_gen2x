...
// clang-format off
// IPJ_autogen | gen_c_regions_ex10_regulatory | region_name:ISRAEL {
static channel_index_t const israel_usable_channels[] = {28};
    ...
    .regulatory_channels =
        {
            ...
            .usable_count   =
                (channel_size_t)ARRAY_SIZE(israel_usable_channels),
            .random_hop     = false,
        },
    .pll_divider    = 24,
