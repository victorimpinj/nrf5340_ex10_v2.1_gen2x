...
// clang-format off
// IPJ_autogen | gen_c_regions_ex10_regulatory | region_name:VIETNAM {
static channel_index_t const vietnam_usable_channels[] = {
    ...
    .regulatory_channels =
        {
            ...
            .usable_count   =
                (channel_size_t)ARRAY_SIZE(vietnam_usable_channels),
            .random_hop     = true,
        },
    .pll_divider    = 24,
